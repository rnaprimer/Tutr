        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-gray-200">
          <div>
            ...
            <h1 className="text-2xl font-bold text-gray-900">
              Tuition Request with {req.tutor?.display_name || 'Tutor'}
            </h1>
        ...
        <div className="mt-6 p-4 rounded-lg text-sm bg-gray-50 border border-gray-200">
          {req.status === 'PENDING' && (
            <p className="text-amber-800">
              <span className="font-semibold">Waiting for tutor response:</span> The tutor has been notified and is reviewing your request. You will be able to begin classes once they accept.
            </p>
          )}
          {req.status === 'ACCEPTED' && (
          ...
          {req.status === 'DECLINED' && (
            <p className="text-gray-700">
              <span className="font-semibold">Request Declined:</span> The tutor was unable to accept this request due to scheduling or capacity. You can browse other tutors in Balasore.
            </p>
          )}
