...
import { getStudentRequests } from '@/lib/data/tutor-requests'
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Link href="/dashboard/student" className="text-sm text-indigo-600 hover:text-indigo-500">
              &larr; Dashboard
            </Link>
          </div>
          <h1 className="text-2xl font-bold text-gray-900">My Tutor Requests</h1>
          <p className="text-sm text-gray-600 mt-1">
            Track and manage your requests to verified local tutors in Balasore.
          </p>
        </div>
        <Link
          href="/tutors"
      ...
      {requests.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center max-w-md mx-auto my-8">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">You haven&apos;t requested a tutor yet.</h3>
          <p className="text-sm text-gray-500 mb-6">
            Explore verified local tutors in Balasore and submit a request tailored to your learning requirements.
          </p>
          <Link
            href="/tutors"
          ...
          {requests.map(req => (
            ...
            >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-gray-900">
                      {req.tutor?.display_name || 'Verified Tutor'}
                    </h3>
              ...
              <div className="mt-4 pt-3 border-t border-gray-100 flex justify-end">
                <Link
                  href={`/dashboard/student/requests/${req.id}`}
